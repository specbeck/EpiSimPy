...
def display_banner():
    ...
    console.print("[italic]Simulate epidemic dynamics using SIR or SEIRD models[/italic]", style="cyan")

def get_simulation_parameters():
    """Interactive prompts to get simulation parameters from the user."""
    console.print("\n[bold]Enter Simulation Parameters[/bold]", style="magenta")
    model = Prompt.ask("Choose the epidemic model", choices=["SIR", "SEIRD"], default="SIR")
